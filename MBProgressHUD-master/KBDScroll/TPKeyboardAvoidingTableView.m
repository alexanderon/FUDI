...
@synthesize kbdDelegate = _kbdDelegate;
...
-(void)textFieldDidEndEditing:(UITextField *)textField{
    NSLog(@"Tag %d",(int)textField.tag);
    if ([self.kbdDelegate respondsToSelector:@selector(textFieldDidEndEditing:)]) {
        [self.kbdDelegate textFieldDidEndEditing:textField];
    }
}
...
-(void)textFieldDidBeginEditing:(UITextField *)textField {
    ...
    if ([self.kbdDelegate respondsToSelector:@selector(textFieldDidBeginEditing:)]) {
        [self.kbdDelegate textFieldDidBeginEditing:textField];
    }
}
